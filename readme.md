...
| Phase 6 多人旅行與商品化基礎 | 第二輪進行中 | Nomica Insights、TripMember 個人月報偏好、預算頁輕量深化、收支頁資訊架構、帳戶流向分析、資產頁帳戶健康度與旅行頁狀態中心已完成第一輪；Money Flow 移到 Phase 7，帳號 provider、iOS/PWA 登入、timezone、匯率與投資/資金分配獨立頁列入後續評估 |
