...
| Phase 6 多人旅行與商品化基礎 | 進行中 | Nomica Insights 已收斂為狀態中心；TripMember 個人月報偏好與預算頁輕量深化已完成第一輪；Money Flow 移到 Phase 7，帳號 provider、iOS/PWA 登入、timezone、匯率與投資/資金分配獨立頁列入後續評估 |
