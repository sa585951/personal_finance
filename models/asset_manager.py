...
class AssetManager:
    ...
    def transfer(self, user_id, source_key, dest_key, amount):
        ...
        source_balance = self.db_session.execute(balance_stmt).scalar_one_or_none()
        ...
        self.db_session.execute(update_source_stmt)
        ...
        result = self.db_session.execute(update_dest_stmt)
